...
const FIELD_DEFS: Record<string, FieldDef> = {
  ...
  subjective_adj_max: {
    label: "Límite confidence_adjustment (±)",
    description: "Tope aplicado al ajuste fino del LLM en cada decisión: confidence = base × certeza_LLM + adjustment. Valores fuera del rango se recortan automáticamente. Efecto en el próximo ciclo del decisor.",
