...
export function App() {
    return (_jsxs(BrowserRouter, { children: [_jsx(NavBar, {}), _jsx("main", { className: "p-6", children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Dashboard, {}) }), _jsx(Route, { path: "/trades", element: _jsx(Trades, {}) }), _jsx(Route, { path: "/decisions", element: _jsx(Decisions, {}) }), _jsx(Route, { path: "/playbook", element: _jsx(PlaybookPage, {}) }), _jsx(Route, { path: "/config", element: _jsx(Config, {}) }), _jsx(Route, { path: "/health", element: _jsx(Health, {}) })] }) })] }));
}
